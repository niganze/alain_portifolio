      ...
      <div className="qualification_container">
        <div className="alain">
          <div className="amazingly_left">
            ...
            <p>
              ...
              software, and systems  and other 
            </p>
          </div>
          ...
          <div className="amazingly_left">
            ...
            <p>
              Where am developing and connecting a new generation of ethical,
              entrepreneurial leaders for more connection.
            </p>
          </div>
          <hr style={{ borderColor: "blue" }} />
        </div>
        <div className="alaing">
          <div className="amazingly_right">
            ...
            <p><h5>Session</h5>:2017- 2019</p>
            <p>Result: 3.78 (In the Scale 50%-80%)</p>
          </div>
          <div className="amazingly_right">
            <h4>General certificate in KLAB</h4>
            <p>Session:2023-Present</p>
            <p>Result: 3.78 (In the Scale of 80%)</p>
          </div>
          <div className="amazingly_right">
            <h4>freecodecamp & Fine Arts</h4>
            <p>Session:2019-2020</p>
            <p>Result: 3.78 (In the Scale of 4.00)</p>
          </div>
        </div>
      </div>
    </div>
